...
export default function Sidebar(){
    return(
  <div class="fixed top-20 left-0 bottom-28 bg-gray-900 border-r border-gray-800 pt-7 pb-10 px-3 mt-10">
    <div class="px-6">
      <a class="text-xl font-semibold text-white">Dashboard</a>
    </div>
